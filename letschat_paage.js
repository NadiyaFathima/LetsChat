...
like_button = "<button class='btn_like' id='" + firebase_message_id + "'value='" + like + "'onclick='updateLikes(this.id)'>";
...
function updateLikes(message_id){
      console.log("Clicked on like button whose Id is " + message_id);
